...
import com.animestudios.animeapp.databinding.BottomSheetSelectorBinding
import com.animestudios.animeapp.databinding.ItemStreamBinding
import com.animestudios.animeapp.databinding.ItemUrlBinding
            ...
            if (media != null && !loaded) {
                ...
                if (ep != null) {
                    ...
                    if (selected != null) {
                        ...
                        makeDefault = readData("make_default") ?: true
...
//                )
            ...
            if (video.format == VideoType.CONTAINER) {
                ...
                if ((readData<Int>("settings_download_manager") ?: 0) == 0) {
